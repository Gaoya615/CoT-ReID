...
class build_transformer(nn.Module):
    ...
    def forward(self, image, text=None, label=None, cam_label=None, view_label=None, modality=None):
        ...
        if text is not None:
            ...
            # print(text_features.shape) 32,512
            # print(global_feat_text.shape) 32
        ...
        # 计算图像特征
        image_features = self.base.encode_image(image)#, cv_embed)#, modality)#, text_inverse=None)
